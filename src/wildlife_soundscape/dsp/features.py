...
class FeatureConfig:
    ...
    def __post_init__(
        ...
        if (
            ...
            raise ValueError(
                "hop_length must be greater than 0."
            )
        ...
        if (
            ...
            raise ValueError(
                (
                    "n_mels must be greater "
                    "than or equal to n_mfcc."
                )
            )
...
def extract_acoustic_features(
    ...
    *,
    ...
    if (
        ...
        raise ValueError(
            (
                "FeatureConfig sample_rate "
                "does not match "
                "PreprocessedAudio sample_rate."
            )
        )
    ...
    if (
        amplitude_signal.size
        != analysis_signal.size
    ):
